...
export const pawnEndingSteps: LessonStep[] = [
  ...
  // ========================================
  {
    ...
    id: 'pe-shoulder-01',
    title: 'Shouldering',
    instruction: 'White has the opposition and Black steps aside with Kf7. Don\'t follow! Instead, shoulder with Kd6 — stepping diagonally forward to push Black backward. Now Black can\'t return to d7 or e7.',
  ...
  },
  {
    ...
    instruction: 'Black steps aside with Kf7. White shoulders with Kd6 — a body check! What will be the result?',
    startFen: '8/4k3/8/4K3/4P3/8/8/8 b - - 0 1',
    introMoves: ['Kf7', 'Kd6'],
    answer: 'white',
    proofMoves: ['Ke8', 'Ke6'],
    endState: 'promotion',
