...
export const pawnEndingSteps: LessonStep[] = [
  ...
  // ========================================
  {
    ...
    instruction: 'The kings face off — but it\'s Black\'s turn! Black must step aside, and White marches to the key square.',
    startFen: '8/3k4/8/3K4/3P4/8/8/8 b - - 0 1',
    introMoves: ['Ke7', 'Kc6'],
    answer: 'white',
    // NOTE: proof moves need user verification in-browser
    proofMoves: ['Kd8', 'Kd6', 'Ke8', 'Kc7', 'Kf7', 'd5', 'Ke7', 'd6+', 'Ke8', 'd7+', 'Kf7', 'd8=Q'],
    endState: 'promotion',
  },
  {
    type: 'quiz',
    ...
    instruction: 'Same position — but now White moves first! White steps aside, and Black holds the opposition. The pawn can\'t break through.',
