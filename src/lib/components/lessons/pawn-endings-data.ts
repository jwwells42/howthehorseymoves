...
export const pawnEndingSteps: LessonStep[] = [
  ...
  // ========================================
  {
    ...
    id: 'pe-keysq-01',
    title: 'Key Squares',
    instruction: 'If White\'s king reaches a starred square, the pawn will promote — no matter what Black does.',
  ...
  // ========================================
  {
    ...
    instruction: 'White\'s king reaches d6 — a key square! What will be the result?',
  ...
  },
  {
    ...
    id: 'pe-opposition-02',
    title: 'Opposition',
    instruction: 'Black takes the opposition with Kd8 — blocking the key squares. What will be the result?',
