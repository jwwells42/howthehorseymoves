...
export const rookPuzzles: Puzzle[] = [
  ...
  },
  {
    ...
    setup: [
      ...
      { piece: "P", color: "b", square: "b1" },
    ],
    targets: ["a8"],
    solution: ["a3", "h3", "h8", "a8"],
    maxMoves: 5,
  ...
  },
  {
    ...
    setup: [
      { piece: "R", color: "w", square: "a1" },
      { piece: "P", color: "b", square: "c1" },
      { piece: "P", color: "b", square: "a3" },
      { piece: "P", color: "b", square: "c3" },
      { piece: "P", color: "b", square: "e2" },
    ],
    targets: ["e4"],
    solution: ["b1", "b4", "e4"],
    maxMoves: 4,
