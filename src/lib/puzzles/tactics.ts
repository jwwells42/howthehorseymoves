...
export const pinPuzzles: Puzzle[] = [
  ...
  },
  {
    ...
    instruction: "Pins work against queens too! Pin the knight to the queen, then take it!",
    setup: "3q2k1/5ppp/8/8/3n4/4R3/6PP/6K1 w - - 0 1",
    targets: ["d3", "d4"],
    solution: ["d3", "d4"],
    opponentResponses: [{ from: "d8", to: "c8" }],
    arrows: [{ from: "d3", to: "d8", color: "#15803d" }],
    maxMoves: 2,
    hints: [
      "The knight on d4 and the queen on d8 are on the same file.",
      "If the rook moves to d3, the knight is stuck — moving it loses the queen!",
      "Rd3 pins the knight to the queen. After the queen retreats, capture with Rxd4!",
    ],
    starThresholds: { three: 2, two: 3, one: 4 },
  },
];
