...
export const pinPuzzles: Puzzle[] = [
  {
    ...
    instruction: "A pin traps a piece on a line — it can't move without exposing the king. Pin the knight!",
    setup: "3qkr2/pp6/2n5/8/8/1B6/5PPP/6K1 w - - 0 1",
    targets: ["a4"],
    solution: ["a4"],
    maxMoves: 1,
    hints: [
      "The knight on c6 is on the same diagonal as the king on e8.",
      "If the bishop lands on a4, it attacks c6 — and the king is behind it!",
      "Ba4 pins the knight. It can't move without exposing the king to check.",
    ],
