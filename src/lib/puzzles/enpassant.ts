...
export const enPassantPuzzles: Puzzle[] = [
  ...
  },
  {
    id: "enpassant-10",
    piece: "P",
    title: "The Only Capture",
    instruction: "The black pawn is defended from the front. Use en passant to take it!",
    setup: [
      { piece: "P", color: "w", square: "f5" },
      { piece: "P", color: "b", square: "e5" },
      { piece: "P", color: "b", square: "e7" },
    ],
    enPassantSquare: "e6",
    targets: ["e6"],
    solution: ["e6"],
    maxMoves: 1,
    hints: [
      "You can't capture the e5 pawn by advancing — another pawn blocks that path.",
      "En passant lets you capture diagonally to e6, removing the e5 pawn.",
    ],
    starThresholds: { three: 1, two: 1, one: 2 },
  },
];
