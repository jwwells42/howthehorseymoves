...
export const CURRICULUM: CurriculumChapter[] = [
  ...
  // ── Level 7: The Charger ────────────────────
  {
    ...
    stops: [
      ...
      { id: 'pawn-endings-lesson', name: 'Pawn Endings', icon: '/pieces/wK.svg', href: '/learn/pawn-endings-lesson', progress: { type: 'localStorage', key: 'pawn-endings-lesson-best-stars' } },
